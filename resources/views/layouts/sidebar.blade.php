...
<div class="quixnav">
    <div class="quixnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="/" aria-expanded="false"><i class="icon icon-home"></i><span class="nav-text">Home</span></a>
            </li>
            @auth
                ...
                @if (in_array('CST', $rolesUser))
                    <li><a href="{{ route('riwayatTransaksi', auth()->user()->id) }}" aria-expanded="false"><i 
                                class="icon icon-single-04"></i><span class="nav-text">Riwayat Transaksi</span></a></li>
                @endif
            @endauth
